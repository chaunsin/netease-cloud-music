...
type PlaylistDetailResp struct {
	...
	Playlist      struct {
		...
		Tracks []struct {
			...
			Alg                  any            `json:"alg"`
			DisplayReason        any            `json:"displayReason"`
	...
	FromUsers       any                `json:"fromUsers"`
	FromUserCount   int64              `json:"fromUserCount"`
	SongFromUsers   any                `json:"songFromUsers"`
}
...
type RadioRespData struct {
	...
	Privilege       struct {
		...
		PlLevels           any                      `json:"plLevels"`
		DlLevels           any                      `json:"dlLevels"`
	} `json:"privilege"`
	Alg string `json:"alg"`
}
...
type PCRecentListenListRespData struct {
	...
	Resources []struct {
		...
		ResourceCode     any      `json:"resourceCode"`
		...
		SimilarFmType    any      `json:"similarFmType"`
		DateNum          any      `json:"dateNum"`
		Star             bool     `json:"star"`
		...
		SongIdList any `json:"songIdList"`
		PlayIndex  any `json:"playIndex"`
	} `json:"resources"`
}
