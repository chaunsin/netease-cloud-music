...
type DjRadioSubResp struct {
	...
	DjRadios []struct {
		...
		Icon            any    `json:"icon"`
		ManualTagsDTO   any    `json:"manualTagsDTO"`
		DescPicList     []struct {
			...
			NestedData any    `json:"nestedData"`
		} `json:"descPicList"`
		ReplaceRadioId        int64   `json:"replaceRadioId"`
		ReplaceRadio          any     `json:"replaceRadio"`
		...
		ParticipateUidList    []any   `json:"participateUidList"`
		OperateUidList        []any   `json:"operateUidList"`
